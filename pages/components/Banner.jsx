    ...
    >
      ...
      customPaging: i => (
        <div
          ...
          className="rounded-2xl hover:bg-blue-400 text-white shadow-2xl shadow-blue-400 bg-whit m-4 -top-50"
        >
          {i + 1}
        </div>
      )
    ...
    <div className=''>
      ...
      <Slider {...settings} className='overflow-hidden'>
        <div className=' flex relative w-full '>
          ...
          <p className=' absolute  left-1/3 mx-2 md:left-1/3 top-1/3 text-3xl   md:text-7xl text-r text-white font-extrabold'>
            Zim’s Leading Research Insights Agency
          </p>
        </div>
        <div className=' flex relative w-full'>
          ...
          <div  className=' absolute  left-1/3 mx-2 md:left-1/3 top-1/3 text-3xl   md:text-7xl text-r text-white font-extrabold'>
